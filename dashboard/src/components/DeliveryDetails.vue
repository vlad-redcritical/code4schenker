<template>
  <b-card header="Current details">
    <ul class="list-group">
      <li class="danger-bg list-group-item d-flex justify-content-between">Speed: <span>{{speed}}</span></li>
      ...
      <li class="warning-bg list-group-item d-flex justify-content-between">Pressure: <span>{{pressure}}</span></li>
