<template>
    <div class="delivery-details">
        <div class="card" v-if="details">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li :class="['list-group-item', 'd-flex', 'justify-content-between', {'success': detail.status.success}, {'warning': detail.status.warning}, {'danger':detail.status.danger}]"
                        v-for="(detail, index) in details"
                        :key="index">
                        {{detail.name}}: <span>{{detail.value}} {{detail.unit}}</span>
                    </li>
                </ul>
