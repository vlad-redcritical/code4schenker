...
privileged aspect VetService_Roo_Service {
     ...
     * @return Page
     */
    public abstract Page<VetInfo> VetService.findAll(GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Page
     */
    public abstract Page<VetInfo> VetService.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable);
