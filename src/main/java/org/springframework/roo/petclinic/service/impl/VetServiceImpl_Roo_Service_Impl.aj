...
privileged aspect VetServiceImpl_Roo_Service_Impl {
     ...
     * @return Map
     */
    public Map<String, List<MessageI18n>> VetServiceImpl.validate(Vet vet) {
     ...
     * @return Page
     */
    public Page<VetInfo> VetServiceImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Page
     */
    public Page<VetInfo> VetServiceImpl.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable) {
