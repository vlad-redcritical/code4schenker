...
privileged aspect OwnersCollectionJsonController_Roo_JSON {
    ...
    declare @type: OwnersCollectionJsonController: @RestController;
    
    declare @type: OwnersCollectionJsonController: @RequestMapping(value = "/owners", name = "OwnersCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
